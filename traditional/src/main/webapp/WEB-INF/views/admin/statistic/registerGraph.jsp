...
<body id="body-pd">
	...
	<div id="wrap" style="padding: 0px 20px;">
		...
		<div id="recommend">
			<h6 style="margin: 10px;">&nbsp;&nbsp;&nbsp;&nbsp;통계 > 회원 가입자 수 ${date == "2" ? "> 월별" : "> 일별"}</h6>
		</div>
		...
		<main>
			...
			<div style="width: 80%; height: 80%; margin: 0px auto;">
				<form name="dateForm"
					action="${pageContext.request.contextPath}/admin/statistic/statistic.do"
					method="post">
						...
						<thead>
							<tr>
								...
								<td><span style="align-items: flex-end;">기간</span> <select
									...
									<button type="submit"
										onclick="location.href='${pageContext.request.contextPath}/admin/statistic/statistic.do';">
										전송</button></td>
							</tr>
