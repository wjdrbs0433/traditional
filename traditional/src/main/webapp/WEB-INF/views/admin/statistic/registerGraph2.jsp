	...
	<div id="wrap" style="padding: 0px 20px;">
		<div class="navbar" style="margin-top: 52px;">
			...
			<a class="navbar-brand"
				...
				style="position: absolute; left: 45%;"> 통 계 </a>

		</div>
		<hr>
		<div id="recommend">
			<h6 style="margin: 10px;">&nbsp;&nbsp;&nbsp;&nbsp;통계 > 회원 가입자 수</h6>
		</div>
		...
		<main>
			...
			<div style="width: 80%; height: 80%; margin: 0px auto;">
				<form name="dateForm"
					action="${pageContext.request.contextPath}/statistic/graph.do"
					method="post">
						...
						<thead>
							<tr>
								...
								<td><span style="align-items: flex-end;">기간</span> <select
									...
									<button type="submit"
										onclick="location.href='${pageContext.request.contextPath}/admin/statistic/graph.do';">
										전송</button></td>
							</tr>
