...
<div class="container">
	<div class="dash">
		<div class="box1">
			<table class="dashbox">
				<tr>
					<th onclick="location.href='${pageContext.request.contextPath}/admin/statistic/graph.do';"><i class="fa-solid fa-store"></i>&nbsp; 회원 가입자 통계</th>
				</tr>
			</table>
			
			<table class="dashbox">
				<tr>
					<th onclick="location.href='${pageContext.request.contextPath}/admin/statistic/sales.do';"><i class="fa-solid fa-truck-fast"></i>&nbsp; 매출 관리 </th>
				</tr>
			</table>
