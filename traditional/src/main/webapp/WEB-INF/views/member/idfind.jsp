...
function idfind() {
	...
	const registerForm = document.forms['idfindForm'];
...
<form method="post" name="idfindForm" autocomplete="off" action="${pageContext.request.contextPath}/member/idfind_ok.do">
	...
	<div style="float: left; position: relative; width: 45%; height: 100vh;">
		<div style="position: absolute; top: 50%; width: 400px; left: 50%; transform: translate(-50%, -50%);">
			...
			<div id="register-text">
				...
				<button type="button" class="btn" style="width: 100%; border-radius: 20px; height: 50px; color: white; font-weight: bold;" onclick="idfind();">아이디 찾기</button>
				<a href="${pageContext.request.contextPath}/member/pwdfind.do" style="margin-left: 10px">비밀번호찾기</a>
