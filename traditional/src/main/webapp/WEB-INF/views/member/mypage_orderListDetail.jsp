...
vertical-align: middle;" > 받는 분 정보 </span>
		...
		<hr>
		<!-- 이름 + 전화번호(가운데 4자리는 *로) -->
		<div style="height: 55px;" style="justify-content: space-around;" >
			<span style="font-weight: bold; display: inline-block; width: 40%; text-align: center; line-height: 55px;
vertical-align: middle;">받는 분</span>
			<span style="font-weight: bold; display: inline-block; width: 40%; line-height: 55px;
vertical-align: middle;">${dto.memberName} / ${dto.memberPhone}</span>
		</div>
		<hr>
		<div style="height: 55px;" >
			<span style="font-weight: bold; display: inline-block; width: 40%; text-align: center; line-height: 55px;
vertical-align: middle;">주소</span>
			<span style="font-weight: bold; display: inline-block; width: 40%; line-height: 55px;
vertical-align: middle;">${dto.memberAddress1}</span>
		</div>
		<hr>
		<div style="height: 55px;" >
			<span style="font-weight: bold; display: inline-block; width: 40%; text-align: center; line-height: 55px;
vertical-align: middle;">배송 메모</span>
			<span style="font-weight: bold; display: inline-block; width: 40%; line-height: 55px;
vertical-align: middle;">${dto.orderRequire}</span>
		</div>
	</div>
...
vertical-align: middle;" >계산서 (${dto.orderDate})</span>
		...
		<div style="height: 70px; border-bottom: 0.5px double lightgray;">
			<span style="color: black; font-weight: bold; font-size: 20px; display: inline-block; width: 45%; text-align: left; line-height: 70px;
vertical-align: middle;" >총 주문 금액</span>
			<span style="font-weight: bold"> ${dto.totalPrice} </span>
		</div>
		<hr>
		<!-- 주문상태 -->
		<div style="height: 70px;">
			<span style="color: black; font-weight: bold; font-size: 20px; display: inline-block; width: 45%; text-align: left; line-height: 70px;
vertical-align: middle;" > 상품 금액 </span>
			<span style="font-weight: bold"> ${dto.orderPrice} </span>
		</div>

		<div style="height: 70px; border-bottom: 0.5px solid lightgray;">
			<span style="color: black; font-weight: bold; font-size: 20px; display: inline-block; width: 45%; text-align: left; line-height: 70px;
vertical-align: middle;" > 배송비 </span>
			<span style="font-weight: bold"> ${dto.shippingFee} </span>
		</div>
		...
		<div style="height: 70px; border-bottom: 0.5px double lightgray;">
			<span style="color: black; font-weight: bold; font-size: 20px; display: inline-block; width: 45%; text-align: left; line-height: 70px;
vertical-align: middle;" > 총 할인 금액 </span>
			<span style="font-weight: bold"> 0원 </span>
		</div>
		<div style="height: 70px;">
			<span style="color: black; font-weight: bold; font-size: 20px; display: inline-block; width: 45%; text-align: left; line-height: 70px;
vertical-align: middle;" > 상품 할인 </span>
			<span style="font-weight: bold"> 0원 </span>
		</div>
		<div style="height: 70px; border-bottom: 1px double lightgray;">
			<span style="color: black; font-weight: bold; font-size: 20px; display: inline-block; width: 45%; text-align: left; line-height: 70px;
vertical-align: middle;" > 쿠폰 할인 </span>
			<span style="font-weight: bold"> 0원 </span>
		</div>
		
		<div style="height: 70px;">
			<span style="color: black; font-weight: bold; font-size: 20px; display: inline-block; width: 45%; text-align: left; line-height: 70px;
vertical-align: middle;" > 총 결제 금액 </span>
			<span style="font-weight: bold"> ${dto.totalPrice} </span>
		</div>	
		<div style="height: 70px;">
			<span style="color: black; font-weight: bold; font-size: 20px; display: inline-block; width: 45%; text-align: left; line-height: 70px;
vertical-align: middle;" > 결제 방법 </span>
			<span style="font-weight: bold"> 카카오페이 </span>
		</div>
